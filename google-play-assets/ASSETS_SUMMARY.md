# Google Play Store Assets Summary
...
**Location:** `google-play-assets/screenshots/`

**How to create:**
1. Run the ChessBoard app on device or emulator
2. Navigate to different screens
3. Take screenshots (Power + Volume Down on device, or emulator camera icon)
4. Save screenshots to `google-play-assets/screenshots/` folder

**Suggested Screenshots:**
1. Main game board view
2. Move history with seekbar
3. Save/Load dialog
4. Fullscreen mode
5. Promotion dialog
...
- [ ] Screenshot 3+ - Additional features (optional)

## Quick Upload Guide

1. **App Icon:**
   - Play Console > Store listing > App icon
...
3. **Screenshots:**
   ...
   - Order them logically (main screen first)
